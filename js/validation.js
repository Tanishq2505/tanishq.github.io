$(document).ready(function() {
    $("#send_message").click(function(a) {
        ...
        0 == b && ($("#send_message").attr({
            disabled: "true",
            value: "Sending..."
        }), $.post("https://formspree.io/f/mjvdnedz", $("#contact_form").serialize(), function(a,b) {
             b ? ($("#submit").remove(), $("#mail_success").fadeIn(500)) : ($("#mail_fail").fadeIn(500), $("#send_message").removeAttr("disabled").attr("value", "Send The Message"))
        }))
    })
});